...
def test_live_stream_options_gemini_flash_keeps_minimal_reasoning_for_latency():
...
def test_live_stream_options_disables_qwen_reasoning_to_prevent_thinking_leaks():
...
def test_screen_gpt56_gets_deliberate_reasoning_and_full_code_room():
