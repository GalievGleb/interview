...
export const en: Record<I18nKey, string> = {
  ...
  'overlay.clickThroughTip': 'Passes all clicks through the overlay. Ctrl+Alt+0 (zero) toggles the mode and restores control. Ctrl+Alt+O (letter O) also works',
  ...
  'settings.sub.account': 'Sign-in, subscription and devices for your account.',
  ...
  'account.title': 'SkillCue account',
  'account.subtitle': 'Your subscription follows your account and works on two of your devices.',
  'account.google': 'Continue with Google',
  'account.emailFallback': 'Sign in or register with email',
  'account.email': 'Email',
  ...
  'account.resend': 'Send another code',
  ...
  'account.noPlan': 'No active subscription',
  'account.unavailable': 'Accounts are not enabled in this build yet. Local data and your legacy licence still work.',
  'account.loading': 'Loading account…',
  'account.error': 'The action failed. Please try again.',
  'account.deviceLimit': 'The limit is two devices. Disconnect an old device, then sign in again.',
  'account.codeSent': 'A code was sent to your email.',
  'account.resetDone': 'Password changed. You can now sign in.',
  'backup.title': 'Backup',
  'backup.desc': 'Save your profile, resume, history, settings and drafts before reinstalling. Passwords, cookies and sign-in credentials are never included.',
  'backup.export': 'Save backup',
  'backup.import': 'Restore from backup',
  'backup.saved': 'Backup saved.',
  'backup.preview': 'Backup from {date}: {files} files and {settings} local settings. Current data will be replaced after SkillCue creates a rollback copy.',
  'backup.confirm': 'Confirm restore',
  'backup.cancel': 'Do not restore',
  'backup.restarting': 'Data restored. SkillCue is restarting…',
  'backup.error': 'The backup could not be processed.',
  ...
  'plan.renew': 'Extend access',
  'plan.upgrade': 'Upgrade to Max',
  'plan.downgradeUnavailable': 'Available after Max expires',
  'plan.checkoutNote':
